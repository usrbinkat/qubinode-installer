    ...
    case $PRODUCT_OPTION in
          ...
          ocp4)
              ...
              then
                  ...
                  ASK_SIZE=true
                  rhel_major=$(awk '/^qcow_rhel_release:/ {print $2}' "${project_dir}/project/vars/idm.yml")
                  setup_download_options 
          ...
          satellite)
              ...
              then
                  ...
                  rhel_major=$(awk '/^qcow_rhel_release:/ {print $2}' "${project_dir}/project/vars/satellite.yml")
                  setup_download_options
                  download_files
